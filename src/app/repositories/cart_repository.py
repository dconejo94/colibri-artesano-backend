...
class CartRepository(ABC):
    ...
    @abstractmethod
    async def remove_order_item(self, product_id: UUID, store_order_id: UUID) -> OrderItem:
        pass

    @abstractmethod
    async def update_order_item(self, product_id: UUID, store_order_id: UUID, quantity: int) -> OrderItem:
        pass
